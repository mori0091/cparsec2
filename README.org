...
#+CAPTION: Example 1. parse a number by using built-in parser ~number~
[[file:docs/images/parsec1.png]]

#+CAPTION: Example 2. parse zero or more number by using parser-combinator ~many(p)~
[[file:docs/images/parsec2.png]]
